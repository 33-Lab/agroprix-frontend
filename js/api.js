...
async function fetchCompare(commodity){var dbName=stripAccents(AP.cultureNames[commodity]||commodity);var url=AP.API_BASE+'/api/prices/compare?commodity='+encodeURIComponent(dbName);var json=await fetchRobust(url,'compare_'+dbName);return(json&&json.data)?json.data:[];}
